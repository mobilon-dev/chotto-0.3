export const messages = [
  ...
  },
  {
    ...
    actions: [{ action: 'edit', title: 'изменить', icon: 'https://dummyimage.com/64x64/000/fff.png&text=pin' }, { action: 'delete', title: 'удалить' }]
  },
  { chatId: 1, type: "message.text", text: "Привет!", direction: 'outgoing', status: 'received', timestamp: '1727027959', actions: [{ action: 'edit', title: 'изменить', icon: 'https://dummyimage.com/64x64/000/fff.png&text=pin' }, { action: 'delete', title: 'удалить' }] },
  { chatId: 1, type: "message.image", url: "https://nationaltoday.com/wp-content/uploads/2022/05/Sun-Day--1200x834.jpg", timestamp: '1727027959', alt: "Example Image", direction: 'outgoing', status: 'received', actions: [{ action: 'edit', title: 'изменить', icon: 'https://dummyimage.com/64x64/000/fff.png&text=pin' }, { action: 'delete', title: 'удалить' }] },
  ...
  { chatId: 2, type: "message.file", url: "https://axiomabio.com/pdf/test.pdf", filename: "Документ.pdf", direction: 'incoming', status: 'received', timestamp: '1727027959', actions: [{ action: 'edit', title: 'изменить' }, { action: 'delete', title: 'удалить' }] },
  { chatId: 2, type: "message.text", text: "Привет!", direction: 'incoming', status: 'read', timestamp: '1727027959' },
  { chatId: 2, type: "message.audio", url: "https://file-examples.com/storage/fe40e015d566f1504935cfd/2017/11/file_example_MP3_700KB.mp3", text: "Привет!", direction: 'incoming', status: 'received', subText: '89829445678', timestamp: '1727027959', actions: [{ action: 'edit', title: 'изменить' }, { action: 'delete', title: 'удалить' }] },
  { chatId: 2, type: "message.audio", url: "https://file-examples.com/storage/fe40e015d566f1504935cfd/2017/11/file_example_MP3_700KB.mp3", text: "Привет!", direction: 'outgoing', status: 'received', subText: '89829445678', timestamp: '1727027959', actions: [{ action: 'edit', title: 'изменить' }, { action: 'delete', title: 'удалить' }] },
