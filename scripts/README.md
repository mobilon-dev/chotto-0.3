...
- 📋 **Детальную проверку каждого компонента** - результаты 8 типов валидации
...
#### 9. Валидация глобальных тем (src/themes/*/vars.scss)
...
- **8 типов проверок** на каждый компонент + проверка глобальных тем
