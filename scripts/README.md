...
Скрипт для комплексной валидации системы тем в проекте chotto-0.3. Выполняет **7 типов проверок** для обеспечения консистентности и типобезопасности.
...
- **Глобальные переменные в темах компонентов**: `--chotto-theme-spacing-md` в файле `styles/themes/light.scss`
...
- **7 типов проверок** на каждый компонент
